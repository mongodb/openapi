...
// Source: github.com/mongodb/openapi/tools/foas/openapi/filter (interfaces: Filter)
//
// Generated by this command:
//
//	mockgen -destination=../filter/mock_filter.go -package=filter github.com/mongodb/openapi/tools/foas/openapi/filter Filter
//

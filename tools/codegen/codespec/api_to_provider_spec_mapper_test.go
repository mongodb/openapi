		...
		expectedResult: &codespec.Model{
			Resources: []codespec.Resource{{
				Schema: &codespec.Schema{
					Description: codespec.StringPtr(testResourceDesc),
					Attributes: codespec.Attributes{
						{
							Name:                     "bool_default_attr",
							ComputedOptionalRequired: codespec.ComputedOptional,
							Bool:                     &codespec.BoolAttribute{Default: codespec.Pointer(false)},
						},
						{
							Name:                     "count",
							ComputedOptionalRequired: codespec.Optional,
							Int64:                    &codespec.Int64Attribute{},
							Description:              codespec.StringPtr(testFieldDesc),
						},
						{
							Name:                     "create_date",
						...
						},
						{
							...
							String:                   &codespec.StringAttribute{},
							Description:              codespec.StringPtr(testPathParamDesc),
							ReqBodyUsage:             codespec.OmitAlways,
						},
						{
							Name:                     "num_double_default_attr",
							Float64:                  &codespec.Float64Attribute{Default: codespec.Pointer(2.0)},
							ComputedOptionalRequired: codespec.ComputedOptional,
						},
						{
					...
					Attributes: codespec.Attributes{
						{
							...
							ComputedOptionalRequired: codespec.Optional,
							String:                   &codespec.StringAttribute{},
							Description:              codespec.StringPtr("Always in updates"),
						},
						{
							Name:                     "cluster_name",
							ComputedOptionalRequired: codespec.Required,
						...
						},
						{
							...
							ComputedOptionalRequired: codespec.Optional,
							String:                   &codespec.StringAttribute{},
							Description:              codespec.StringPtr("Optional string"),
						},
						{
				...
				Schema: &codespec.Schema{
					...
					Attributes: codespec.Attributes{
									...
									Attributes: codespec.Attributes{
										{
											...
											ComputedOptionalRequired: codespec.Required,
											Int64:                    &codespec.Int64Attribute{},
											Description:              codespec.StringPtr("Overridden inner_num_attr_alias description"),
										},
										{
											Name:                     "list_primitive_string_computed_attr",
											ComputedOptionalRequired: codespec.Computed,
						...
						},
						{
							...
							ComputedOptionalRequired: codespec.ComputedOptional,
							String:                   &codespec.StringAttribute{},
							Description:              codespec.StringPtr("Optional string that has config override to optional/computed"),
						},
						{
							Name:                     "outer_object",
							ComputedOptionalRequired: codespec.Computed,
													...
													Attributes: codespec.Attributes{
														{
															...
															ReqBodyUsage:             codespec.OmitAlways,
															String:                   &codespec.StringAttribute{},
															Description:              codespec.StringPtr("Overridden level_field1_alias description"),
														},
													},
												},
											},

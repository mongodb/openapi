    ...
    errors: [
      {
        ...
        message:
          'The response body schema must reference a schema with a Request suffix. ',
      ...
      },
      {
        code: 'xgen-IPA-106-create-method-request-body-is-request-suffixed-object',
        message:
          'The response body schema is defined inline and must reference a predefined schema. ',

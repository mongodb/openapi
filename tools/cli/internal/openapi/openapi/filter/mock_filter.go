...
//
//	mockgen -destination=../openapi/filter/mock_filter.go -package=filter github.com/mongodb/openapi/tools/cli/internal/openapi/filter Filter
//
...
import (
	...
	filter "github.com/mongodb/openapi/tools/cli/internal/openapi/filter"
...
func (m *MockFilter) Apply(arg0 *openapi3.T, arg1 *filter.Metadata) error {
	m.ctrl.T.Helper()

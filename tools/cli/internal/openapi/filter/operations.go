...
// Filter: OperationsFilter is a filter that removes the x-xgen-owner-team extension from operations and moves the x-sunset extension to the operation level.

	...
	}{
		{
			...
			entries: []*OasDiffEntry{
				...
				},
				{
					...
					Text:        "the response property `results/items/tags/items/key` became required for the status `200`",
					Operation:   "GET",
				...
				{
					ID:          "response-property-became-required",
					Text:        "the response property `results/items/tags/items/value` became required for the status `200`",
					Operation:   "GET",
					OperationID: "listProjects",
					Path:        "/api/atlas/v2/groups",
				},
				{
					...
					Text:        "removed the optional property `results/items/audienceClaim` from the response with the `200` status",
					Operation:   "GET",
				...
				{
					ID:          "response-optional-property-removed",
					Text:        "removed the optional property `results/items/audience` from the response with the `200` status",
					Operation:   "PUT",
					OperationID: "UpdateIdentityProviders",
					Path:        "/api/atlas/v2/federationSettings/{federationSettingsId}/identityProviders",
				},
				{
					...
					Text:        "added the optional property `results/items/payments/items/currency` to the response with the `200` status",
					Operation:   "PUT",
				...
				{
					ID:          "response-optional-property-added",
					Text:        "added the optional property `results/items/payments/items/unitPrice` to the response with the `200` status",
					Operation:   "PUT",
					OperationID: "listInvoices",
					Path:        "/api/atlas/v2/orgs/{orgId}/invoices",
				},
				{
					...
					Text:        "added the required property `results/items/oneOf[subschema #10: NDS X509 User Authentication Alert Configuration]/matchers/items/fieldName` to the response with the `200` status", //nolint:lll //Test string
					Operation:   "POST",
				...
				{
					ID:          "response-required-property-added",
					Text:        "added the required property `results/items/oneOf[subschema #10: NDS X509 User Authentication Alert Configuration]/matchers/items/operator` to the response with the `200` status", //nolint:lll //Test string
					Operation:   "POST",
					OperationID: "createConnectedOrgConfigs",
					Path:        "/api/atlas/v2/federationSettings/{federationSettingsId}/connectedOrgConfigs",
				},
				{
					ID:          "response-required-property-added",
					Text:        "added the required property `results/items/oneOf[subschema #10: NDS X509 User Authentication Alert Configuration]/matchers/items/value` to the response with the `200` status", //nolint:lll //Test string
					Operation:   "POST",
					OperationID: "createConnectedOrgConfigs",
					Path:        "/api/atlas/v2/federationSettings/{federationSettingsId}/connectedOrgConfigs",
				},
			...
			expectedEntries: []*OasDiffEntry{
				...
				{
					ID:          "response-property-became-required",
					Text:        "the response properties 'results/items/tags/items/key, results/items/tags/items/value' became required for the status '200'",
					Operation:   "GET",
					OperationID: "listProjects",
					Path:        "/api/atlas/v2/groups",
				},
				{
					ID:          "response-optional-property-removed",
					Text:        "removed the optional properties 'results/items/audience, results/items/audienceClaim' from the response with the '200' status",
					Operation:   "PUT",
					OperationID: "UpdateIdentityProviders",
					Path:        "/api/atlas/v2/federationSettings/{federationSettingsId}/identityProviders",
				},

...
func TestSplitPublicPreviewRun(t *testing.T) {
	...
	fs := afero.NewMemMapFs()
	opts := &Opts{
		basePath:   "../../foas/test/data/base_spec_with_public_preview.json",
		outputPath: "foas.yaml",
		fs:         fs,
		env:        "dev",
		format:     "yaml",
...
func TestSplitPrivatePreviewRun(t *testing.T) {
	...
	fs := afero.NewMemMapFs()
	opts := &Opts{
		basePath:   "../../foas/test/data/base_spec_with_private_preview.json",
		outputPath: "foas.yaml",
		fs:         fs,
		env:        "dev",
		format:     "yaml",
...
func TestSplitUpcomingRun(t *testing.T) {
	...
	fs := afero.NewMemMapFs()
	opts := &Opts{
		basePath:   "../../foas/test/data/openapi_with_upcoming.json",
		outputPath: "foas.yaml",
		fs:         fs,
		env:        "dev",
		format:     "yaml",

...
[![OpenAPI (jp)](https://img.shields.io/badge/openapi-click%20to%20preview-rgb(71%2C162%2C72)?style=for-the-badge&logo=mongodb)](https://bump.sh/mongodb/doc/atlas-admin-api-v2-cloud-dev/)
...
This repository hosts the OpenAPI specification for the [Atlas Administration API (v2.0)](https://bump.sh/mongodb/doc/atlas-admin-api-v2-cloud-dev/).
